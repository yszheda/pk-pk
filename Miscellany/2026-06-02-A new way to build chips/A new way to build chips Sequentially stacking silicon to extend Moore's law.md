...
由伊利诺伊州 Grainger 工程学院教授曹庆领导的研究人员展示了一种可扩展的方法，可以直接顺序堆叠高性能硅电路。这一进步是实现三维芯片全部潜力的关键一步，这些芯片可以将计算能力超越传统缩放的极限。*
...
半个多世纪以来，计算机的强大是通过缩小晶体管并将它们更紧密地堆叠在平面芯片上实现的。这效果太好。设备现在变得如此之小，以至于它们开始受到原子尺寸和量子效应的根本限制。
...
下一步的突破可以来自增加一个新的维度：向上构建。通过垂直堆叠硅电路层，芯片制造商可以在降低能耗的同时，显著提高计算密度和速度，为在不进一步缩小晶体管的情况下延长摩尔定律提供了一条有希望的途径。
...
“如今，在单个平面上需要六个称为晶体管的微电子设备来存储一位信息。通过垂直整合，你可以将它们分布到多个层上。”**
...
伊利诺伊大学 Grainger 工程材料科学与工程学院教授青曹解释道：“以静态随机存取存储器为例，它在 CPU 和 GPU 中普遍存在。如今，在单个平面上需要六个名为晶体管的微电子设备来存储一个比特的信息。通过垂直集成，可以将它们分布在多个层上。这就像将一个蔓延的郊区替换为高层建筑：你获得相同的功能，但空间占用减少，同时层间通信更快更高效。”
...
最有效的方法，称为整体三维集成，直接在每一层上构建下一层，以最大化层间连接性。然而，实现这一点一直是一个长期的技术挑战。制备高质量的硅和制造高性能器件通常需要 1000 摄氏度高温的工艺，高温足以破坏金属布线。对于第一层以上的上层，温度限制，即“热预算”，严格设定为 400 摄氏度。

![[cr][lf]&amp;lt;p&amp;gt;A freestanding sheet of single&amp;acirc;&amp;euro;&amp;lsquo;crystalline silicon nanomembrane is held above a silicon wafer patterned with its first layer of electronic circuits.&amp;lt;/p&amp;gt;[cr][lf]](https://matse.illinois.edu/_sitemanager/viewphoto.aspx?id=123218&s=719)

A freestanding sheet of single‑crystalline silicon nanomembrane is held above a silicon wafer patterned with its first layer of electronic circuits. 一片独立的单晶硅纳米膜片被悬置在刻有第一层电子电路图案的硅晶片上方。
...
由曹领导的伊利诺伊州格拉宁工程学院研究团队现已证明，在多个层级中仍可保持该限制的同时实现高设备性能是可能的。他们新发明的工艺使用单晶硅——工业中主要的半导体材料——并在学术实验室洁净室环境中展示了 98‒100%的设备良率，表明其在工业应用中具有巨大潜力。
...
“垂直整合已经开始进入商用设备，特别是在专门的 AI 硬件中，但单片整合才是释放 3D 芯片全部潜力的关键，”曹先生说。“我们首次使用标准的单晶硅实现了单片 3D 整合的热预算，并交付了前所未有的性能。”

This study appears in Nature as one of the journal’s rare research articles focused on silicon microelectronics.  
这项研究作为《自然》杂志罕见关注硅微电子的研究文章之一发表在该期刊上。

The work was conducted within Illinois Grainger Engineering’s [Center for Advanced Semiconductor Chips with Accelerated Performance](https://asap.hmntl.illinois.edu/), which counts IBM, Intel, and the Taiwan Semiconductor Manufacturing Company, among its industry partners. The team is now preparing to translate their process to an industrial semiconductor foundry.  
这项工作是在伊利诺伊州 Grainger 工程公司的先进半导体芯片加速性能中心进行的，该中心拥有 IBM、英特尔和台积电等行业合作伙伴。现在，该团队正在准备将其工艺转移到工业半导体晶圆厂。
...
微电子制造在过去 60 年里一直由摩尔定律驱动，该定律指出芯片上晶体管的密度应该每两年翻一番。电子行业将这一原则作为生产目标，以提高计算机处理器的功率和效率。它在几十年里被证明是成功的和稳定的，但有一些迹象表明这一趋势开始停滞不前。
...
“从某种意义上说，我们正遇到物理学设定的限制，”曹先生说。“如果你看晶体管的实际尺寸，它们并没有变得更小，尤其是在接触栅极间距方面。这是因为我们正受到硅的固有材料特性和量子力学的根本规则的限制。如果我们想要继续提高我们微处理器的处理能力，我们必须开始思考，而不仅仅是将更多设备压缩在单个表面上。”
...
许多专家认为，未来的发展方向将是向上垂直整合设备。这为扩展提供了空间，而无需进一步缩小单个设备。它还缩短了所需的布线长度，减少了寄生电容，同时大幅提高了设备与电路块之间的通信带宽。这些特性为人工智能和其他形式的数据密集型计算提供了关键优势。
...
“如果我们要保持微处理器处理能力增加的趋势，我们必须开始思考，而不仅仅是将更多设备压缩在单个表面上。”**

Associate Professor Qing Cao, Department of Materials Science and Engineering  
材料科学与工程系副教授青曹

![](https://matse.illinois.edu/_sitemanager/viewphoto.aspx?id=123213&s=1991)

Pictured: Associate Professor Qing Cao holds a 200-mm wafer covered with multiple layers of vertically stacked silicon membranes. 图中：副教授曹庆手持一块 200 毫米的晶圆，上面覆盖着多层垂直堆叠的硅膜。
...
当前商业三维芯片是通过先在独立的晶圆衬底上制造半导体器件，然后将这些晶圆或芯片粘合在一起制成的。虽然这种方法已经成功生产了高带宽内存和 3D V-Cache 芯片等产品，但它存在显著的限制。层与层之间的对准必然粗糙，而且被称为硅通孔或 TSV 的层间微米级垂直连接相对较大且稀疏。
...
相比之下，整体式三维集成采用了一种根本不同的方法。它不是堆叠完整的晶圆，而是在制造过程中将每个设备层直接依次构建在先前层之上。这种工艺允许实现更密集（10-100 倍）的层间垂直连接，更小的层间间隔，以及纳米级精度的层间精确对准。

![[cr][lf]&amp;lt;p&amp;gt;A roll laminator transfers the ultrathin, freestanding silicon membranes onto the receiving wafer, enabling uniform wafer&amp;acirc;&amp;euro;&amp;lsquo;scale stacking for 3D chip fabrication.&amp;amp;nbsp;&amp;lt;/p&amp;gt;[cr][lf]](https://matse.illinois.edu/_sitemanager/viewphoto.aspx?id=123221&s=1991)

A roll laminator transfers the ultrathin, freestanding silicon membranes onto the receiving wafer, enabling uniform wafer‑scale stacking for 3D chip fabrication. 一台卷对卷薄膜转移机将超薄的独立硅膜转移到接收晶圆上，实现均匀的晶圆级堆叠，用于 3D 芯片制造。
...
实现该过程的主要障碍是温度。形成高质量的晶体硅以及制造高性能半导体器件都需要接近 1000 摄氏度的温度，而用于器件间通信的金属互连在远低于这一点时就会熔化。
...
“通常，行业普遍认为，一旦第一层电路完成，任何额外层的最高热预算限制为 400 摄氏度，”曹先生说。“学术界和工业界的研究人员都试图通过使用非单晶硅的半导体材料来制造上层电路来绕过这一限制。但由此产生的设备不可避免地存在性能和可靠性问题。”
...
已探索的替代方案包括多晶硅、非晶态或纳米晶金属氧化物，以及碳纳米管和二维半导体等纳米材料。它们都存在源于材料固有属性或加工过程中引入的外部缺陷的限制，导致在起始硅晶圆衬底上构建的硅晶体管的底层与上层之间存在不匹配。
...
伊利诺伊州 Grainger 工程团队开发了一种使用标准单晶硅实现单片三维集成的方法。该方法首先从捐赠晶圆上制造超薄、独立的硅纳米膜，然后使用卷对卷层压机将这些膜转移到已包含完成底层电路的接收基板上。该过程在 200 摄氏度以下即可在基板和转移层之间形成牢固的连接。因此，在保持硅膜的高结晶质量的同时，实现了高性能和可靠性，并且该过程很好地控制在热预算范围内。
...
“我们的方法不仅更容易实施且成本更低，而且在堆叠硅晶圆方面比以前的方法有几个优势，”曹先生说。“我们转移的膜厚度仅为 10 纳米或更小，而典型的晶圆厚度为 500 到 700 微米。由于它们很薄，这些膜在机械上具有柔韧性，可以贴合底层表面。这种贴合性有助于避免界面缺陷，如空洞，这些缺陷在试图通过晶圆键合将两个刚性晶圆强行结合在一起时很常见。”
...
团队还需要重新思考晶体管的设计和制造。传统的晶体管制造需要一种称为“掺杂”的过程，向硅中引入杂质以控制其电学特性。这是一个高温过程，通常超过 600 摄氏度，并且器件的不同区域需要不同的掺杂。为了解决这个问题，研究人员使用了称为“无结晶体管”的器件，其中在层叠步骤之前，硅被均匀且高度掺杂。由于薄膜非常薄，栅极仍然可以有效地控制沟道，而高掺杂水平降低了寄生接触电阻。

![](assets/viewphoto.aspx)

Schematic (left) and false-colored electron microscopy image (right) of a monolithic 3D static random-access memory cell, featuring six transistors distributed across three vertically stacked layers. 原理图（左）和伪彩色电子显微镜图像（右）显示了一个模块化 3D 静态随机存取存储器单元，该单元包含六个晶体管分布在三个垂直堆叠的层中。
...
利用该工艺，团队构建了三层堆叠结构，每层包含 625 个晶体管，具有良好的良率和均匀性。这些晶体管的输出电流密度与在体硅晶圆上、更高温度下制造的标凘硅晶体管相当，至少比由替代材料制成的单片器件高三到四倍，表明性能有显著提升。通过垂直金属线连接这些层，研究人员展示了三维集成逻辑电路和静态随机存取存储器单元。
...
“但最重要的是，我们已经证明了这个过程是可扩展的，”曹说。“你可以继续堆叠超过我们演示的三层。这个过程将产生高性能、高良率、低变异性的晶体管。我们现在有坚实的基础来转移这项技术，并在一个工业半导体晶圆厂中展示其立即的潜力。”
...
Bao Lam，Yung Man Yu，Hyunjun Nam，Hsu-Chih Ni，Shomik Chatterjee，Shaloo Rakheja，和 Jian-Min Zhuo 也为这项研究做出了贡献。*

*The article, “* [Monolithic three-dimensional integration of silicon transistors](https://www.nature.com/articles/s41586-026-10496-6),*” is available online. DOI: 10.1038/s41586-026-10496-6*  
文章“硅晶体管的块状三维集成”，可在网上获取。DOI: 10.1038/s41586-026-10496-6
...
支持来自美国国家科学基金会、伊利诺伊州格拉宁工程学院先进半导体芯片加速性能中心行业合作伙伴以及硅交叉微电子公共枢纽。*

**Illinois Grainger Engineering Affiliations  
伊利诺伊州 Grainger 工程协会**

[Qing Cao](https://matse.illinois.edu/people/profile/qingcao2) is an Illinois Grainger Engineering associate professor of materials science and engineering in the [Department of Materials Science and Engineering](https://matse.illinois.edu/). He is also affiliated with the [Department of Electrical and Computer Engineering](https://ece.illinois.edu/) and the [Department of Chemistry](https://chemistry.illinois.edu/). He is a member of the [Materials Research Laboratory](https://mrl.illinois.edu/) and the [Holonyak Micro and Nanotechnology Laboratory](https://hmntl.illinois.edu/).  
青高是伊利诺伊州格拉宁工程学院材料科学与工程学院的副教授。他还隶属于电气与计算机工程系和化学系。他是材料研究实验室和霍洛尼 ak 微纳米技术实验室的成员。

[Shaloo Rakheja](https://grainger.illinois.edu/about/directory/faculty/rakheja) is an Illinois Grainger Engineering associate professor of electrical and computer engineering in the [Department of Electrical and Computer Engineering](https://ece.illinois.edu/). She is the director of the [Center for Advanced Semiconductor Chips with Accelerated Performance (ASAP)](https://asap.hmntl.illinois.edu/). She is a member of the [Holonyak Micro and Nanotechnology Lab](https://hmntl.illinois.edu/) and [Coordinated Science Laboratory](https://csl.illinois.edu/). She holds the Intel Alumni Endowed Faculty Fellow appointment.  
Shaloo Rakheja 是伊利诺伊大学 Grainger 工程学院电气与计算机工程系的副教授。她是先进半导体芯片加速性能中心（ASAP）的主任。她是 Holonyak 微纳米技术实验室和协调科学实验室的成员。她担任 Intel 校友捐赠教席研究员。

Jian-Min Zhuo is an Illinois Grainger Engineering Professor Emeritus of materials science and engineering in the [Department of Materials Science and Engineering](https://matse.illinois.edu/).  
Jian-Min Zhuo 是伊利诺伊大学材料科学与工程学院的名誉 Grainger 工程教授，专攻材料科学与工程。